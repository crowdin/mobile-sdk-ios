...
@objcMembers public class CrowdinLoginConfig: NSObject {
    ...
    @available(*, deprecated, message: "Plesae pass organizationName to CrowdinProviderConfig: CrowdinProviderConfig(hashString: distributionHash, sourceLanguage: sourceLanguage, organizationName: organizationName)")
