...
class EnableSDKLocalizationTests: IntegrationTestCase {
    ...
    func testAutoSDKModeEnabled() {
        ...
        _ = CrowdinSDK.addDownloadHandler {
            XCTAssert(CrowdinSDK.currentLocalization == "en", "Should auto detect current localization as en")
            expectation.fulfill()
        }
    ...
    func testManualSDKModeEnabled() {
        ...
        _ = CrowdinSDK.addDownloadHandler {
            XCTAssert(CrowdinSDK.currentLocalization == "de", "Should set current localization to de")
            expectation.fulfill()
        }
