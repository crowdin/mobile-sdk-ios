---
description: Capture and upload tagged screenshots from your iOS app to Crowdin to give translators visual context. Learn about setup, authorization, and config options.
---
...
target 'your-app' do
    ...
    pod 'CrowdinSDK/Settings' # Optional. To add the SDK Controls floating button
end
```

:::info Swift Package Manager
If you installed the SDK via Swift Package Manager, no additional setup is needed - the Screenshots functionality is already included in the `CrowdinSDK` package.
:::
...
import screenshotsApiSetupSwift from '!!raw-loader!../code-samples/screenshots-api-setup.swift';
import screenshotsApiSetupC from '!!raw-loader!../code-samples/screenshots-api-setup.m';

<Tabs groupId="language">
  <TabItem value="swift" label="Swift"><CodeBlock language="swift" title="AppDelegate.swift">{screenshotsApiSetupSwift}</CodeBlock></TabItem>
