...
Crowdin Authorization is required for Screenshots feature. You can use one of two authentication methods. **Important**: If both authentication methods are configured, access token authentication will take priority over OAuth authentication.
