...
Crowdin Authorization is required for Real-Time Preview feature. You can use one of two authentication methods. **Important**: If both authentication methods are configured, access token authentication will take priority over OAuth authentication.

#### Access Token Authentication

You can authenticate using an access token:
...
Handle authorization callback in your application:
...
| `accessToken`              | Access token for Crowdin API authentication. Note: When both access token and OAuth login config are provided, access token authentication takes priority                                                                                                                                                                                                                                                                            | `accessToken: "your_access_token"`                       |
