...
//        CrowdinSDK.start(with: LocalLocalizationProvider())
        ...
        let crowdinProviderConfig = CrowdinProviderConfig(hashString: "66f02b964afeb77aea8d191e68748abc", stringsFileNames: ["/%osx_code%/Localizable.strings"], pluralsFileNames: ["/%osx_code%/Localizable.stringsdict"], localizations: ["en", "de"])
