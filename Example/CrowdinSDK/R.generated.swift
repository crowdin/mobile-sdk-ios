...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      ...
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let main_title = Rswift.StringResource(key: "main_title", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Головна [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let menu_main_button_title = Rswift.StringResource(key: "menu_main_button_title", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Деталі [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let details_title = Rswift.StringResource(key: "details_title", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Значення0 [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let details_segmentedControl_0 = Rswift.StringResource(key: "details_segmentedControl_0", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Значення1 [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let details_segmentedControl_1 = Rswift.StringResource(key: "details_segmentedControl_1", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Кнопка [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let details_button = Rswift.StringResource(key: "details_button", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Лейбл [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let details_label = Rswift.StringResource(key: "details_label", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Налаштування [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let menu_settings_button_title = Rswift.StringResource(key: "menu_settings_button_title", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Оновити UI [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let main_reload_ui_button = Rswift.StringResource(key: "main_reload_ui_button", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Параметер [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let test_parameter = Rswift.StringResource(key: "test_parameter", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      ...
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let main_show_details_button = Rswift.StringResource(key: "main_show_details_button", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Тест [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let test_key = Rswift.StringResource(key: "test_key", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      ...
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let settings_in_sdk = Rswift.StringResource(key: "settings_in_sdk", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: У бандлі [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let settings_in_bundle = Rswift.StringResource(key: "settings_in_bundle", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
      /// uk translation: Якийсь текст [BUNDLE]
      /// 
      /// Locales: uk, zh-Hans, zh-Hans-CN, zh-Hant, uk-UA, en
      static let details_textfield_placeholder = Rswift.StringResource(key: "details_textfield_placeholder", tableName: "Localizable", bundle: R.hostingBundle, locales: ["uk", "zh-Hans", "zh-Hans-CN", "zh-Hant", "uk-UA", "en"], comment: nil)
